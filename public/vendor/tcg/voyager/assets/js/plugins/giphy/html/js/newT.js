/*
    ...
    Usage:
        ...
        Render DOM Elements
            ...
            @param (any) the data to pass to the method emailUsage in the second parameter of newT.save("name", func);
...
(function (temp) {
  ...
  T.prototype = {
    ...
    // generic version of the function emailUsage to build the element specific creation functions
    ...
    element: function(type, attributes, content) {
      ...
      if(attributes) {
        // when is not an attribute... but can accept a test case that can be emailUsage for conditional rendering
